// junfeipage/working/projectprofile/projectprofile.js
var sliderWidth = 40;
...
function getprootherlist(isRefresh, that) {
    isRefresh = isRefresh || false;
    var prdata = {
        Statuz: "-2",
        Start: that.data.Start,
...
Page({
    ...
    onLoad: function () {
        ...
        var tabscompany = [{ "name": "全部", "statuz": "-2", num: "" }, { "name": "实施中", "statuz": "2", num: "" }, { "name": "待验收", "statuz": "3", num: "" }, { "name": "验收不过", "statuz": "41", num: "" }, { "name": "审核不过", "statuz": "121", num: "" }];
    ...
    projectrectap: function (e) {
        ...
        wx.navigateTo({
            url: 'projectprofiledetail/projectprofiledetail?profileid=' + e.currentTarget.dataset.profileid
    ...
    proaccepttap: function (event) {
        ...
        wx.navigateTo({
            url: 'prdetail/prdetail?pritemid=' + pritemid + '&projectid=' + projectid
        })
    }
});