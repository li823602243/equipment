// junfeipage/working/toolscompany/toolscompany.js
const requiredata = require('../../../utils/util.js').request_data;
const requireUrl = require('../../../config.js');
let app = getApp();
function toolscompanyData(isRefresh, that) {
  isRefresh = isRefresh || false;
  var toolscompanydata = {
  ...
  //调用企业查询接口
  requiredata.toolscompany(requireUrl.toolscompanyUrl, toolscompanydata, function (res) {
    console.log("企业查询", toolscompanydata, res.data)
    if (res.data.flag == "-1") {
      that.wetoast.toast({
        title: '登录超时',
        duration: 1000,
